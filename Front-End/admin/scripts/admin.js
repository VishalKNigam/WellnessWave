...
function fetchDetails() {
  ...
  fetch(`https://wellnesswave-rs9y.onrender.com/myorder/allorders`, {
    method: "GET",
    headers: {
      authorization: `Bearer ${saveToken.token}`,
    },
...
addnNew.addEventListener("submit", (e) => {
  ...
  fetch(`https://wellnesswave-rs9y.onrender.com/products/add`, {
    method: "POST",
    headers: {
      "content-type": "application/json",
      authorization: `Bearer ${saveToken.token}`,
...
updateProduct.addEventListener("submit", (e) => {
  ...
  fetch(
    `https://wellnesswave-rs9y.onrender.com/products/update/${updateID.value}`,
    {
      method: "PATCH",
      headers: {
        "content-type": "application/json",
...
deleteProduct.addEventListener("submit", (e) => {
  ...
  fetch(
    `https://wellnesswave-rs9y.onrender.com/products/delete/${deleteID.value}`,
    {
      method: "DELETE",
      headers: {
        "content-type": "application/json",
...
function fetchDataAfterPagination(page, query) {
  // console.log(page);
  fetch(
    `https://wellnesswave-rs9y.onrender.com/products/?page=${page}&limit=${ProductLimit}`
  )
    .then((res) => res.json())
    .then((res) => {
      // console.log(res.products);

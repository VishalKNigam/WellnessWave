...
function fetchDataAfterPagination(page, query) {
  // console.log(page);
  fetch(
    `https://wellnesswave-rs9y.onrender.com/products/?page=${page}&limit=${ProductLimit}&${query}`
  )
    .then((res) => res.json())
    .then((res) => {
...
function fetchData(
  ...
  if (
    ...
    fetch(`https://wellnesswave-rs9y.onrender.com/products/`)
      .then((res) => res.json())
      .then((res) => {
    ...
    fetch(`https://wellnesswave-rs9y.onrender.com/products/?rating=${rating}`)
      .then((res) => res.json())
      .then((res) => {
        let length = res.products.length
        // console.log(page)
    ...
    fetch(
      `https://wellnesswave-rs9y.onrender.com/products/?category=${c1}&category=${c2}&category=${c3}&category=${c4}&category=${c5}&category=${c6}`
    )
      .then((res) => res.json())
      .then((res) => {
        let length = res.products.length
    ...
    fetch(
      `https://wellnesswave-rs9y.onrender.com/products/?brand=${b1}&brand=${b2}&brand=${b3}&brand=${b4}&brand=${b5}&brand=${b6}&brand=${b7}`
    )
      .then((res) => res.json())
      .then((res) => {
        let length = res.products.length
        ...
        for (let i = 1; i <= total; i++) {
          pagination.append(
            createbtn(
              i,
              i,
              `brand=${b1}&brand=${b2}&brand=${b3}&brand=${b4}&brand=${b5}&brand=${b6}&brand=${b7}`
            )
          )
        }
        let diff = length - 12
    ...
    fetch(
      `https://wellnesswave-rs9y.onrender.com/products/?category=${c1}&category=${c2}&category=${c3}&category=${c4}&category=${c5}&category=${c6}&rating=${rating}`
    )
      .then((res) => res.json())
      .then((res) => {
        let length = res.products.length
        ...
        for (let i = 1; i <= total; i++) {
          pagination.append(
            createbtn(
              i,
              i,
              `category=${c1}&category=${c2}&category=${c3}&category=${c4}&category=${c5}&category=${c6}&rating=${rating}`
            )
          )
        }
        let diff = length - 12
    ...
    fetch(
      `https://wellnesswave-rs9y.onrender.com/products/?rating=${rating}&price=${price}`
    )
      .then((res) => res.json())
      .then((res) => {
        let length = res.products.length
    ...
    fetch(
      `https://wellnesswave-rs9y.onrender.com/products/?rating=${rating}&brand=${b1}&brand=${b2}&brand=${b3}&brand=${b4}&brand=${b5}&brand=${b6}&brand=${b7}`
    )
      .then((res) => res.json())
      .then((res) => {
        let length = res.products.length
        ...
        for (let i = 1; i <= total; i++) {
          pagination.append(
            createbtn(
              i,
              i,
              `rating=${rating}&brand=${b1}&brand=${b2}&brand=${b3}&brand=${b4}&brand=${b5}&brand=${b6}&brand=${b7}`
            )
          )
        }
        let diff = length - 12
    ...
    (rating || b1 || b2 || b3 || b4 || b5 || b6 || b7 || price) &&
    !c1 &&
    !c2 &&
    !c3 &&
    !c4 &&
    ...
    fetch(
      `https://wellnesswave-rs9y.onrender.com/products/?brand=${b1}&brand=${b2}&brand=${b3}&brand=${b4}&brand=${b5}&brand=${b6}&brand=${b7}&price=${price}&rating=${rating}`
    )
      .then((res) => res.json())
      .then((res) => {
        let length = res.products.length
        ...
        for (let i = 1; i <= total; i++) {
          pagination.append(
            createbtn(
              i,
              i,
              `brand=${b1}&brand=${b2}&brand=${b3}&brand=${b4}&brand=${b5}&brand=${b6}&brand=${b7}&price=${price}&rating=${rating}`
            )
          )
        }
        let diff = length - 12
    ...
    fetch(
      `https://wellnesswave-rs9y.onrender.com/products/?category=${c1}&category=${c2}&category=${c3}&category=${c4}&category=${c5}&category=${c6}&price=${price}`
    )
      .then((res) => res.json())
      .then((res) => {
        let length = res.products.length
        ...
        for (let i = 1; i <= total; i++) {
          pagination.append(
            createbtn(
              i,
              i,
              `category=${c1}&category=${c2}&category=${c3}&category=${c4}&category=${c5}&category=${c6}&price=${price}`
            )
          )
        }
        let diff = length - 12
    ...
    // console.log(b1, b2, b3, b4, b5, b6, b7, rating);
    fetch(
      `https://wellnesswave-rs9y.onrender.com/products/?price=${price}&brand=${b1}&brand=${b2}&brand=${b3}&brand=${b4}&brand=${b5}&brand=${b6}&brand=${b7}`
    )
      .then((res) => res.json())
      .then((res) => {
        let length = res.products.length
        ...
        for (let i = 1; i <= total; i++) {
          pagination.append(
            createbtn(
              i,
              i,
              `price=${price}&brand=${b1}&brand=${b2}&brand=${b3}&brand=${b4}&brand=${b5}&brand=${b6}&brand=${b7}`
            )
          )
        }
        let diff = length - 12
    ...
    fetch(
      `https://wellnesswave-rs9y.onrender.com/products/?category=${c1}&category=${c2}&category=${c3}&category=${c4}&category=${c5}&category=${c6}&brand=${b1}&brand=${b2}&brand=${b3}&brand=${b4}&brand=${b5}&brand=${b6}&brand=${b7}&rating=${rating}&price=${price}`
    )
      .then((res) => res.json())
      .then((res) => {
        let length = res.products.length
        ...
        for (let i = 1; i <= total; i++) {
          pagination.append(
            createbtn(
              i,
              i,
              `category=${c1}&category=${c2}&category=${c3}&category=${c4}&category=${c5}&category=${c6}&brand=${b1}&brand=${b2}&brand=${b3}&brand=${b4}&brand=${b5}&brand=${b6}&brand=${b7}&rating=${rating}&price=${price}`
            )
          )
        }
        let diff = length - 12
...
function getCard(
  ...
  cartButton.addEventListener("click", (e) => {
    ...
    fetch(
      `https://wellnesswave-rs9y.onrender.com/products/delete/${e.target.dataset.id}`,
      {
        method: "DELETE",
        headers: {
